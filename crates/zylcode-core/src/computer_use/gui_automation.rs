...
impl GuiAutomation {
    ...
    pub async fn move_mouse(&self, _x: i32, _y: i32) -> Result<()> {
    ...
    /// Click at position
    pub async fn click(&self, _x: i32, _y: i32, _button: MouseButton) -> Result<()> {
        let start = std::time::Instant::now();
    ...
    pub async fn press_hotkey(&self, _keys: Vec<Key>) -> Result<()> {
        let start = std::time::Instant::now();
    ...
    /// Manage window
    pub async fn manage_window(&self, _action: WindowAction) -> Result<()> {
        let start = std::time::Instant::now();
    ...
    /// Copy to clipboard
    pub async fn copy_to_clipboard(&self, _content: &str) -> Result<()> {
        let start = std::time::Instant::now();
